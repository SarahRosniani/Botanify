...
const Result = () => {
  ...
  console.log('Received data:', responseData); // Debugging line
  ...
  return (
    <div>
          ...
          <div className="result-card">
            <div className="card-result">
              ...
              <div className="card-body-result d-flex">
                <img
                  src={responseData.foto_tanaman}
                  alt={responseData.nama_tanaman}
                  className="plant-image img-fluid mr-3"
                />
                <div className="d-flex flex-column justify-content-between w-100">
                  <div>
                    <h5 className="card-title-result">{responseData.nama_tanaman}</h5>
                  </div>
                  <Accordion defaultActiveKey={['0']} alwaysOpen>
                    <Accordion.Item eventKey="0">
                      <Accordion.Header className="accordion-header">Keterangan</Accordion.Header>
                      <Accordion.Body>
                        {responseData.deskripsi_tanaman}
                        <div className="custom-divider"></div>
                      </Accordion.Body>
                    </Accordion.Item>
                    <Accordion.Item eventKey="1">
                      <Accordion.Header className="accordion-header">Hasil diagnosa</Accordion.Header>
                      <Accordion.Body>
                        <strong>Nama Penyakit:</strong> {responseData.nama_penyakit}
                        <br />
                        <strong>Nama Hama:</strong> {responseData.nama_hama}
                        <div className="custom-divider"></div>
                      </Accordion.Body>
                    </Accordion.Item>
      ...
      <div className="custom-title1">
        ...
        <p>Pelajari bagaimana cara kerja Botanify untuk <br /> mendeteksi penyakit pada tanaman anda</p>
      </div>
      ...
      <div className="custom-title-container2">
        ...
        <div className="custom-titlex2">
          <div className="title-container2">
            ...
            <p>
              AI kami akan bekerja secara cepat dan efisien untuk mendeteksi <br /> penyakit yang ada pada tanaman anda
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="custom-title-container">
        ...
        <div className="custom-titlex3">
          <div className="title-container">
            ...
            <p>
              Anda akan mendapatkan detail dari penyakit tanaman anda dengan <br /> jelas, beserta dengan cara penanganannya
            </p>
          </div>
